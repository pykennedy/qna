...
public class HeaderDecoration extends RecyclerView.ItemDecoration {
  ...
  public HeaderDecoration(View view, boolean scrollsHorizontally, float parallax, float shadowSize,
                          int columns) {
    mView = view;
    TextView tv = (TextView) mView.findViewById(R.id.tv_question_text);
      ...
      if (parent.getChildAdapterPosition(view) == 0) {
        ...
        if (mHorizontal) {
          ...
          if (mShadowSize > 0) {
            ...
            c.drawRect(parent.getLeft(), parent.getTop(), mShadowSize, parent.getBottom(),
                       mShadowPaint);
          }
        } else {
          ...
          if (mShadowSize > 0) {
            ...
            c.drawRect(parent.getLeft(), parent.getTop(), parent.getRight(), mShadowSize,
                       mShadowPaint);
          }
        }
        c.restore();
      ...
      if (mHorizontal) {
        if (mView.getMeasuredWidth() <= 0) {
          mView.measure(
              ...
              View.MeasureSpec
                  .makeMeasureSpec(parent.getMeasuredHeight(), View.MeasureSpec.AT_MOST));
        }
  ...
  public static class Builder {
    ...
    public Builder inflate(@LayoutRes int layoutRes) {
      ...
      BlurView blurView;
      blurView = mView.findViewById(R.id.blurItemViewQuestion);
  
      blurView.setupWith(MainActivity.sFrameLayout)
